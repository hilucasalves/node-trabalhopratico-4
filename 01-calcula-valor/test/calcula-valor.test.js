...
describe('Atividade 02', () => {
  test('O montante deve ser maior que 0', () => {
    // Given (Premissa)
    const montante = 0;
    const numeroPrestacoes = 2;
  ...
  test('O número de parcelas deve ser um número maior que 0', () => {
    // Given (Premissa)
    const montante = 200;
    const numeroPrestacoes = -1;
  ...
  test('O número de parcelas deve ser um número inteiro', () => {
    // Given (Premissa)
    const montante = 200;
    const numeroPrestacoes = 1.5;
